  ...
  return (
    ...
    >
      ...
      <div className="min-h-screen relative z-10 flex flex-col justify-between p-6 md:p-10 max-w-7xl mx-auto">
        ...
        {/* Top Minimal Header */}
        <header className="flex items-center justify-between w-full pt-2 pb-6 border-b border-emerald-900/30">
          <div className="flex items-center gap-3">
            <img
              src="/logo.png"
              alt="IPO Sherpa"
              className="h-8 w-auto rounded-lg drop-shadow-[0_2px_12px_rgba(0,179,134,0.45)]"
            />
            <span className="font-display font-bold text-lg text-white tracking-tight">
              IPO <span className="text-[#00b386]">Sherpa</span>
            </span>
          </div>
          <div className="hidden sm:flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-emerald-400/80 bg-emerald-950/40 border border-emerald-800/40 px-3.5 py-1.5 rounded-full">
        ...
        <div className="py-8 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="hidden lg:flex lg:col-span-3 flex-col gap-6" style={{ animation: 'floatLeft 0.8s cubic-bezier(0.16, 1, 0.3, 1) forwards' }}>
            ...
            <div className="group rounded-2xl p-5 bg-[#0b1e2c]/80 border border-[#1b3d52] backdrop-blur-xl hover:border-[#00b386]/60 transition-all duration-300 shadow-xl hover:-translate-y-1">
              <div className="w-10 h-10 rounded-xl bg-emerald-950/80 border border-emerald-500/30 flex items-center justify-center text-[#00b386] mb-3 group-hover:scale-110 transition-transform">
            ...
            <div className="text-center space-y-3">
              <div className="relative inline-block">
                <img
                  ...
                  style={{
                    filter: 'drop-shadow(0 10px 36px rgba(0,179,134,0.45))'
                  }}
                />
              </div>
              <div>
                <h1 className="text-2xl md:text-3xl font-extrabold text-white tracking-tight font-display">
                  SME IPO <span className="text-[#00b386]">Workspace</span>
                </h1>
                <p className="text-xs font-semibold tracking-[0.18em] uppercase text-emerald-400/80 mt-1">
            ...
            >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    className="w-full bg-[#061520] border border-[#1b3d52] rounded-xl px-4 py-3 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-[#00b386] focus:ring-2 focus:ring-[#00b386]/25 transition-all"
                    type="email"
              ...
              <button
                className="w-full inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#00b386] to-[#4dd4aa] hover:from-[#009970] hover:to-[#3ec098] px-4 py-3.5 text-sm font-extrabold text-slate-950 shadow-lg shadow-[#00b386]/25 disabled:opacity-60 transition-all duration-200 cursor-pointer"
                disabled={loading}
              >
                {loading ? (
              ...
              {successMessage && (
                <div className="p-4 rounded-2xl bg-emerald-950/90 border border-emerald-500/40 flex items-start gap-3 text-[#00b386] text-xs leading-relaxed shadow-xl animate-fade-in-up">
                  <Mail className="w-5 h-5 text-[#00b386] mt-0.5 shrink-0 animate-bounce" />
                  <div>
                    <p className="font-bold text-white text-sm">Check Your Inbox for Verification Email</p>
                    <p className="text-slate-300 text-xs mt-0.5">We've sent a verification link to <span className="text-emerald-400 font-medium">{email}</span>. Please click the link to activate your workspace.</p>
                  </div>
                </div>
              )}
              ...
              <div className="pt-1 text-center">
                <button
                  type="button"
                  className="text-xs font-semibold text-[#00b386] hover:text-[#4dd4aa] transition-colors cursor-pointer"
                  onClick={toggleMode}
                >
                  {mode === 'signin'
        ...
        <div className="flex flex-col items-center justify-center pt-4 pb-2 text-slate-400/80 animate-bounce">
          ...
          <ArrowDown className="w-4 h-4 text-[#00b386]" />
        </div>

      </div>

      {/* ── Apple-Style Feature Presentation Section (Scroll Down) ── */}
      <section className="relative z-10 py-24 px-6 md:px-12 border-t border-emerald-900/30 bg-[#051019]/90 backdrop-blur-2xl">
        <div className="max-w-6xl mx-auto space-y-20">
          
          {/* Main Kinetic Title Banner */}
          <div className="text-center space-y-4 max-w-3xl mx-auto">
            <span className="text-xs font-bold tracking-[0.25em] uppercase text-[#00b386] bg-emerald-950/60 border border-emerald-800/40 px-4 py-1.5 rounded-full inline-block">
            ...
            <h2 className="text-3xl md:text-5xl font-extrabold text-white tracking-tight leading-tight font-display">
              ...
              <span className="bg-gradient-to-r from-[#00b386] via-[#4dd4aa] to-[#a855f7] bg-clip-text text-transparent">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            {/* Feature 1 */}
            <div className="rounded-3xl p-8 bg-[#0a1b26] border border-[#1b3d52] hover:border-[#00b386]/60 transition-all duration-300 shadow-2xl relative overflow-hidden group">
              <div className="absolute top-0 right-0 w-32 h-32 bg-emerald-500/10 rounded-full blur-2xl group-hover:bg-emerald-500/20 transition-all" />
              <div className="w-12 h-12 rounded-2xl bg-emerald-950 border border-emerald-500/40 flex items-center justify-center text-[#00b386] mb-6 group-hover:scale-110 transition-transform">
              ...
              <div className="inline-flex items-center gap-2 text-xs font-semibold text-[#00b386]">
          ...
          <div className="rounded-3xl p-8 bg-gradient-to-r from-[#0a1b26] via-[#0d2636] to-[#0a1b26] border border-[#1d445c] flex flex-col md:flex-row items-center justify-around gap-8 text-center shadow-2xl">
            <div>
              <div className="text-3xl md:text-4xl font-extrabold text-[#00b386] font-display">40+</div>
            ...
            <div>
              <div className="text-3xl md:text-4xl font-extrabold text-[#4dd4aa] font-display">7 Chapters</div>
              <div className="text-xs font-semibold uppercase tracking-wider text-slate-400 mt-1">SEBI ICDR Wizard Steps</div>
            </div>
            <div className="hidden md:block w-px h-12 bg-slate-800" />
            <div>
              <div className="text-3xl md:text-4xl font-extrabold text-[#00b386] font-display">&lt; 2 Seconds</div>
