      ...
      <div className="min-h-screen relative z-10 flex flex-col justify-between p-6 md:p-10 max-w-7xl mx-auto">
        ...
        <header className="flex items-center justify-between w-full pt-2 pb-6 border-b border-accent-900/30">
          <div className="flex items-center gap-3">
            <img
              src="/logo.png"
              alt="IPO Sherpa"
              className="h-8 w-auto rounded-lg drop-shadow-[0_2px_12px_rgba(249,115,22,0.45)]"
            />
        ...
        <div className="py-8 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="hidden lg:flex lg:col-span-3 flex-col gap-6" style={{ animation: 'floatLeft 0.8s cubic-bezier(0.16, 1, 0.3, 1) forwards' }}>
            ...
            <div className="group rounded-2xl p-5 bg-[#0b1e2c]/80 border border-[#1b3d52] backdrop-blur-xl hover:border-[#f97316]/60 transition-all duration-300 shadow-xl hover:-translate-y-1">
              <div className="w-10 h-10 rounded-xl bg-accent-950/80 border border-accent-500/30 flex items-center justify-center text-[#f97316] mb-3 group-hover:scale-110 transition-transform">
            ...
            <div className="text-center space-y-3">
              <div className="relative inline-block">
                <img
                  ...
                  style={{
                    filter: 'drop-shadow(0 10px 36px rgba(249,115,22,0.45))'
                  }}
                />
              </div>
              <div>
                <h1 className="text-[28px] md:text-[34px] font-extrabold text-white tracking-tight font-display">
                  SME IPO <span className="text-[#f97316]">Workspace</span>
                </h1>
            ...
            >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    className="w-full bg-[#061520] border border-[#1b3d52] rounded-xl px-4 py-3 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-[#f97316] focus:ring-2 focus:ring-[#f97316]/25 transition-all"
                    type="email"
              ...
              <button
                className="w-full inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#f97316] to-[#fb923c] hover:from-[#ea580c] hover:to-[#f97316] px-4 py-3.5 text-sm font-extrabold text-slate-950 shadow-lg shadow-[#f97316]/25 disabled:opacity-60 transition-all duration-200 cursor-pointer"
                disabled={loading}
              >
                {loading ? (
              ...
              {successMessage && (
                <div className="p-4 rounded-2xl bg-accent-950/90 border border-accent-500/40 flex items-start gap-3 text-[#f97316] text-xs leading-relaxed shadow-xl animate-fade-in-up">
                  <Mail className="w-5 h-5 text-[#f97316] mt-0.5 shrink-0 animate-bounce" />
                  <div>
              ...
              <div className="pt-1 text-center">
                <button
                  type="button"
                  className="text-xs font-semibold text-[#f97316] hover:text-[#fb923c] transition-colors cursor-pointer"
                  onClick={toggleMode}
                >
                  {mode === 'signin'
      ...
      <section className="relative z-10 py-24 px-6 md:px-12 border-t border-accent-900/30 bg-[#051019]/90 backdrop-blur-2xl">
        <div className="max-w-6xl mx-auto space-y-20">
          ...
          <div className="text-center space-y-4 max-w-3xl mx-auto">
            <span className="text-xs font-bold tracking-[0.25em] uppercase text-[#f97316] bg-accent-950/60 border border-accent-800/40 px-4 py-1.5 rounded-full inline-block">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            {/* Feature 1 */}
            <div className="rounded-3xl p-8 bg-[#0a1b26] border border-[#1b3d52] hover:border-[#f97316]/60 transition-all duration-300 shadow-2xl relative overflow-hidden group">
              ...
              <div className="w-12 h-12 rounded-2xl bg-accent-950 border border-accent-500/40 flex items-center justify-center text-[#f97316] mb-6 group-hover:scale-110 transition-transform">
              ...
              <div className="inline-flex items-center gap-2 text-xs font-semibold text-[#f97316]">
          ...
          <div className="rounded-3xl p-8 bg-gradient-to-r from-[#0a1b26] via-[#0d2636] to-[#0a1b26] border border-[#1d445c] flex flex-col md:flex-row items-center justify-around gap-8 text-center shadow-2xl">
            <div>
              <div className="text-3xl md:text-4xl font-extrabold text-[#f97316] font-display">40+</div>
            ...
            <div>
              <div className="text-3xl md:text-4xl font-extrabold text-[#fb923c] font-display">7 Chapters</div>
              <div className="text-xs font-semibold uppercase tracking-wider text-slate-400 mt-1">SEBI ICDR Wizard Steps</div>
            </div>
            <div className="hidden md:block w-px h-12 bg-slate-800" />
            <div>
              <div className="text-3xl md:text-4xl font-extrabold text-[#f97316] font-display">&lt; 2 Seconds</div>
